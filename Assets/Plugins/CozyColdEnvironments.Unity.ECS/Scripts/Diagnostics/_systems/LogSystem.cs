...
namespace CCEnvs.UnityX.ECS.Diagnostics
{
    ...
    public partial struct LogSystem : ISystem
    {
        public readonly void OnUpdate(ref SystemState state)
        {
            ...
            foreach (var (messageContainerRef, entity) in SystemAPI.Query<RefRO<LogMessageContainer>>().WithEntityAccess())
            {
                ...
                ecb.RemoveComponent<LogMessageContainer>(entity);
            }
