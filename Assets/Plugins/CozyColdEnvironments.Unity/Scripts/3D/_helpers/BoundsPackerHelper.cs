...
{
    //public static class BoundsPackerHelper
    //{
    //    //private static readonly Lazy<Dictionary<PackCacheKey, Bounds[]>> packCache = new(
    //    //    () => new Dictionary<PackCacheKey, Bounds[]>()
    //    //    );

    //    //public static Vector3 CalculateMargin(
    //    //    Bounds container,
    //    //    Bounds item,
    //    //    Axis axis
    //    //    )
    //    //{
    //    //    Bounds firstItem = item;

    //    //    firstItem.center = container.min + item.extents;

    //    //    Bounds lastItem = item;

    //    //    lastItem.center = container.
    //    //}
